...
migration rate there is strong \cite{KeelingRohani2008}. The migration rates are directly proportional to the amount of variation
...
As illustrated in Figure \ref{fig:synchrony-1.pdf}, for a high enough
...
from the Literature \cite{Bolker1995,Choisy2012,Conlan2010,Keeling1997,Keeling2002,KeelingRohani2008}}
...
\begin{figure}[tbph]
\centering \includegraphics[scale=0.4]{smRep100Vil02R001N3e5.pdf} \protect\caption{Kaplan-Meier survival curves for disease persistence after 100 different
...
\begin{figure}[tbph]
\centering \includegraphics[scale=0.4]{plotTOTALnbvillesPhipi2}
...
\begin{figure}
\includegraphics[scale=0.4]{figRELLocalEXTSubPOP_METASIZE_phiMAXpi2.pdf}\protect\caption{Influence of the variation of metapopulation size $N$ on the relation
between the average local extinction number and the number of subpopulation
in a metapopulation. }
...
\begin{figure}
\includegraphics[scale=0.4]{figRELALocalEXTnbSUBPOPphiPI_couplage.pdf}
...
\begin{figure}
\includegraphics[scale=0.4]{figLocalEXTCouplageSUBPOP4.pdf}
