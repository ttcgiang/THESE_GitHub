...
obj1<- globSEIRNewInfec(typeSIMU="stochastic",method="direct",duration=5*365,mu=1/(70*365),sigma=1/8,gamma=1/5,nbVilles=1,N=1e7)
plot(obj1,col="red",ylab="number of infectives", xlab="time (day)") 

#obj2 with method="adaptivetau"
obj2<- globSEIRNewInfec(typeSIMU="stochastic",method="adaptivetau",duration=5*365,mu=1/(70*365),sigma=1/8,gamma=1/5,nbVilles=1,N=1e7)
