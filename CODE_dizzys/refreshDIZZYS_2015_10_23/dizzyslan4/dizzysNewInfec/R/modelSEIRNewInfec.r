...
stoSEIRNewInfec<-function(sigma=1/8,gamma=1/5,mu=1/(70*365),seed=as.numeric(Sys.time()),S=NULL,E=NULL,I=NULL,R=NULL,N=1e5,
	...
	return(new("seirNewInfec",sigma=sigma,gamma=gamma,mu=mu,seed=seed,S=initS,E=initE,I=initI,R=initR,N=initN,
		nbCONTACT0=nbCONTACT0, nbCONTACT1=nbCONTACT1, phiPHASE=phiPHASE,
		probVISITER=probVISITER, probINFECTER=probINFECTER, duration=duration, nbVilles=nbVilles, unitTIME=unitTIME,periDISE=periDISE,		typeRNG=typeRNG,typeSIMU="stochastic",method=method,statSTATE=statSTATE,localExtPOP=listLocalEXTPOP,disRecolPOP=listDisRecolPOP,
		pop=populations))
#the end
}
