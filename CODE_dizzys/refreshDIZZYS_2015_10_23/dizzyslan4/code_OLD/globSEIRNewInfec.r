...
str.seirNewInfec<-function(object,...){
	...
	for(i in 1:nbVilles){	
		...
		######
		parami<-c(N=N,S=S,E=E,I=I,R=R,duration=duration,unitTIME=unitTIME,nbCONTACT0=nbCONTACT0,beta1=beta1,sigma=sigma,gamma=gamma,mu=mu,phiPHASE=phiPHASE)
