...
#
equilibrium<- function(duration=100*365,unitTIME=1,N=10e6,mu=1/(70*365),
    nbCONTACT0=300,nbCONTACT1=.1,probINFECTER=0.1,sigma=1/7,gamma=1/7,phiPHASE=c(0),periDISE=365)
{
	...
	obj_det <- seirDet(duration=duration,unitTIME=unitTIME,N=N,S=sei_eq[1],E=sei_eq[2],I=sei_eq[3],periDISE=periDISE,mu=mu,
