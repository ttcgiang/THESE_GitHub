...
cout<<"ddjddndnnddnn"<<endl;
    ...
    // for simulation
    // for metapopulation
        Garr_probVISITER=arr_probVISITER;
        Garr_nbCONTACT0=arr_nbCONTACT0;
        Garr_nbCONTACT1=arr_nbCONTACT1;
        Garr_probINFECTER=arr_probINFECTER; 
        Garr_probVENIRk=arr_probVENIRk;
        GphiPHASE=phiPHASE;
 cout<<"valSEIRAEEEEEZZZZZZZ"<<endl;
      cout<<"aaaaa "<<GnbVilles<<"  "<<Gsigma<<"  "<<Ggamma<<"  "<<Gmu<<"  "<<GperiDISE<<endl;
      cout<<"valSEIEEEERAAAAAA"<<endl;
        for(int i=0; i<GnbVilles; i++){
            for (int j=0; j<GnbVilles; j++){
                cout<<"    " << Garr_probVISITER[i][j];
	 cout<<"    " << Garr_nbCONTACT0[i][j];
	 cout<<"    " << Garr_nbCONTACT1[i][j];
 cout<<"    " << Garr_probINFECTER[i][j];
 cout<<"    " << Garr_probVENIRk[i][j];
            }
            cout<<endl;
        }
cout<<"valSEIEEEEERAZZZZZZZ"<<endl;
        ...
        */
        ...
        flagSEIR = TRUE;
        if(sigma==INFINITY) flagSEIR=FALSE;
