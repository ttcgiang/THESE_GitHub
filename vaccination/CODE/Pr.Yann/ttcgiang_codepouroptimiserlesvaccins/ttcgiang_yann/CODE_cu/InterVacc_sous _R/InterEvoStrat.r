...
InterEvoStrat <- function(
			...
			EvoStratInput = "EvoStrat_Input.txt",...
			) {
...
switch(menu(nouvellesparametres,graphics=FALSE,title="\n table 3: VALEUR DE PARAMETRES"),
				...
				"tstart","tfinal","periode","tauxVaccToutesVilles","nombreMaxVaccins","nStrategies","nPolitiques","EvoStratInput") -> parametrechoisie;
...
textTotal=paste(text1, text2, text3,text4,text5,text6,text7,text8,text9,text10, text11, text12, text13, text16,text17,text18,text19, text20, text21, text22)
